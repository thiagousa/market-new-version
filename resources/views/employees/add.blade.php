                    ...
                    <div class="form-group">
                        <div class="col-lg-5 col-md-5 col-sm-4 col-xs-6">
                            <div class="form-input">
                                ...
                                {!! Form::text('dateBegin', '', ['class'=>'js-datepicker js-masked-date form-control', 'data-date-format' => 'mm/dd/yyyy', 'placeholder' => 'mm/dd/yyyy', 'id'=>'dateBegin', 'maxlength'=>10]) !!}
                            </div>
                        </div>
                        <div class="col-lg-5 col-md-5 col-sm-4 col-xs-6">
                            <div class="form-input">
                                {!! Form::label('dateBegin', 'Date End') !!}
                                {!! Form::text('dateEnd', '', ['class'=>'js-datepicker js-masked-date form-control', 'data-date-format' => 'mm/dd/yyyy', 'placeholder' => 'mm/dd/yyyy', 'id'=>'dateEnd', 'maxlength'=>10]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::text('function', '', ['class'=>'form-control', 'id'=>'function', 'maxlength'=>45]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
