            ...
            <div class="block-content">
                ...
                <div class="block-content block-content-full">
                    {!! Form::open([
                        ...
                        'url' => route('drawersEditPut')
                        ])
                    !!}
                    {!! Form::hidden('drawerId', $drawer->drawerId) !!}
                    <div class="form-group">
                        <div class="col-lg-6 col-md-6 col-sm-10 col-xs-12">
                            <div class="form-input">
                                {!! Form::label('Number', 'Number *') !!}
                                {!! Form::text('number', $drawer->number, ['class'=>'form-control', 'id'=>'number', 'maxlength'=>2]) !!}
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::text('value', $drawer->value, ['class'=>'form-control', 'id'=>'value', 'maxlength'=>100]) !!}
                                </div>
                            </div>
                        </div>
                    </div>
