        ...
        <div class="block">
            <div class="block-header bg-gray-lighter">
                ...
                <h3 class="block-title">
                    {!! Form::button('<i class="fa fa-plus"></i> Add New', ['class'=>'btn btn-primary', 'onclick'=>'window.open(\''.route('customersAdd').'\', \'_self\');']) !!}
                </h3>
            </div>
                ...
                <table class="table table-bordered table-striped js-dataTable-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="font-w600">{{ $customer->namecia }}</td>
                            <td class="font-w600">{{ $customer->name }}</td>
                            <td class="font-w600">{{ $customer->type->name }}</td>
                            <td class="text-center">
                                {!! Form::button('<i class="fa fa-pencil"></i> ', ['title'=>'Edit', 'data-toggle'=>'tooltip', 'class'=>'btn btn-xs btn-success',
                                    'onclick'=>'window.open(\''.route('customersEdit', $customer->customersId).'\', \'_self\')']) !!}

                                {!! Form::open([
                                    'id' => 'formDelete'.$customer->customersId,
                                    'method' => 'delete',
                                ...
                                'data-url'=>route('customersDelete'), 'data-form'=>1, 'data-id-form'=>'formDelete'.$customer->customersId]) !!}
                                {!! Form::close() !!}
                            </td>
                        </tr>
                        @endforeach
