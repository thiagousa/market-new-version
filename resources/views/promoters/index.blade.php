        ...
        <div class="block">
            <div class="block-header bg-gray-lighter">
                ...
                <h3 class="block-title">
                    {!! Form::button('<i class="fa fa-plus"></i> Add New', ['class'=>'btn btn-primary', 'onclick'=>'window.open(\''.route('promotersAdd').'\', \'_self\');']) !!}
                </h3>
            </div>
            <div class="block-content">
                ...
                <table class="table table-bordered table-striped js-dataTable-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $promoter->promotersId }}</td>
                            <td class="font-w600">{{ $promoter->name }}</td>
                            <td class="font-w600">{{ $promoter->email }}</td>
                            <td class="text-center">
                                {!! Form::button('<i class="fa fa-pencil"></i> ', ['title'=>'Edit', 'data-toggle'=>'tooltip', 'class'=>'btn btn-xs btn-success',
                                    'onclick'=>'window.open(\''.route('promotersEdit', $promoter->promotersId).'\', \'_self\')']) !!}

                                {!! Form::open([
                                    'id' => 'formDelete'.$promoter->promotersId,
                                    'method' => 'post',
                                ...
                                'data-url'=>route('promotersDelete'), 'data-form'=>1, 'data-id-form'=>'formDelete'.$promoter->promotersId]) !!}
                                {!! Form::close() !!}
                            </td>
                        </tr>
                        @endforeach
