...
@section('title', 'Edit TypeCustomer | ')
            ...
            <div class="block-content">
                ...
                <div class="block-content block-content-full">
                    {!! Form::open([
                        ...
                        'url' => route('typeCustomersEditPut')
                        ])
                    !!}
                    ...
                    <div class="form-group">
                        <div class="col-lg-6 col-md-6 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::text('name', $typeCustomer->name, ['class'=>'form-control', 'id'=>'name', 'maxlength'=>100]) !!}
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::text('tax', $typeCustomer->tax, ['class'=>'form-control', 'id'=>'tax', 'maxlength'=>5]) !!}
                                </div>
                            </div>
                        </div>
                    </div>
